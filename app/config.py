...
class Config:
    ...
    CAPTCHA_SITE_KEY   = os.environ.get('CAPTCHA_SITE_KEY', '1x00000000000000000000AA').strip()
    CAPTCHA_SECRET_KEY = os.environ.get('CAPTCHA_SECRET_KEY', '1x0000000000000000000000000000000AA').strip()
